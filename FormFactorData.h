...
public:
    ...
    FormFactorData( float Min, float Max, int NumDataColumns, int NumDataPoints, const char* Filename):
    DataLoader( Min, Max, NumDataColumns, NumDataPoints, Filename){}
...
/*
 ...
 {
 float x; //sin(theta/2)/lambda (theta here is braggtheta*2)
